...
- **Bloc B1 (degel indices) pret** : diag cron+MONIA puis backfill MASI/NSE 06-26→07-09 via scrape_indices_daily --execute --date (idempotent, propagation indRef incluse).
