...
const router=useRouter();
    ...
    <Link href={`/panel/admin/dashboard`}>
      <button
        className={`block w-full py-3 px-4 ${
          pathname.includes('/admin/dashboard') ? 'bg-purple-500' : 'bg-indigo-500'
     ...
     <li>
            ...
            {isSidebarOpenanomalie && (
              <ul className="pl-4 mt-2 space-y-2 text-sm">
                <li>
                  <Link href={`/panel/admin/anomalies/nav-anomalies`}>
                    <button
                ...
                <li>
                  <Link href={`/panel/admin/anomalies/missing-nav`}>
                    <button
                      className={`block w-full py-2 px-2 ${
  ...
  <li>
    <Link href={`/panel/admin/pending-funds`}>
      <button
        className={`block w-full py-3 px-4 ${
          pathname.includes('/admin/pending-funds') ? 'bg-purple-500' : 'bg-indigo-500'
        } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
      >
        Fonds à valider
      </button>
  ...
  {/* Frais */}
  <li>
    <Link href={`/panel/admin/fees`}>
      <button
        className={`block w-full py-3 px-4 ${
          pathname.includes('/admin/fees') ? 'bg-purple-500' : 'bg-indigo-500'
        } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
      >
        Frais
      </button>
  ...
  {/* Gestion des API */}
  <li>
    <Link href={`/panel/admin/api-management`}>
      <button
        className={`block w-full py-3 px-4 ${
          pathname.includes('/admin/api-management') ? 'bg-purple-500' : 'bg-indigo-500'
        } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
      >
        Gestion des API
      </button>
