    ...
    <div>
      ...
      >
        <ul className="space-y-4">
          {/* Tableau de bord */}
          <li>
            <Link href={`/panel/management/dashboard`}>
              <button
                className={`block w-full py-3 px-4 ${
                  pathname.includes('/panel/management/dashboard') ? 'bg-purple-500' : 'bg-indigo-500'
          ...
          <li>
            <button
              ...
              className={`w-full text-left py-3 px-4 ${
                pathname.includes('/panel/management/fonds') ? 'bg-purple-500' : 'bg-indigo-500'
            ...
            {isSidebarOpen && (
              <ul className="pl-4 mt-2 space-y-2 text-sm">
                <li>
                  <Link href={`/panel/management/validated-funds`}>
                    <button
                      className={`block w-full py-2 px-2 ${
                        pathname.includes('/panel/management/validated-funds') ? 'bg-purple-500' : 'bg-indigo-500'
                      } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
                    >
                      Fonds validés
                    </button>
                ...
                <li>
                  <Link href={`/panel/management/pending-funds`}>
                    <button
                      className={`block w-full py-2 px-2 ${
                        pathname.includes('/panel/management/pending-funds') ? 'bg-purple-500' : 'bg-indigo-500'
                      } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
                    >
                      Fonds à valider
                    </button>
                ...
                <li>
                  <Link href={`/panel/management/pending-funds/add-nav`}>
                    <button
                      className={`block w-full py-2 px-2 ${
                        pathname.includes('/panel/management/pending-funds/add-nav') ? 'bg-purple-500' : 'bg-indigo-500'
                      } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
                    >
                      Ajouter un fond
                    </button>
          ...
          {/* Importation globale */}
          <li>
            <Link href={`/panel/management/importfondvl`}>
              <button
                className={`block w-full py-3 px-4 ${
                  pathname.includes('/panel/management/importfondvl') ? 'bg-purple-500' : 'bg-indigo-500'
                } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
              >
                Importation globale
              </button>
          ...
          {/* Personnels */}
          <li>
            <Link href={`/panel/management/personnel`}>
              <button
                className={`block w-full py-3 px-4 ${
                  pathname.includes('/panel/management/personnel') ? 'bg-purple-500' : 'bg-indigo-500'
                } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
              >
                Personnels
              </button>
          ...
          {/* Documents */}
          <li>
            <Link href={`/panel/management/document`}>
              <button
                className={`block w-full py-3 px-4 ${
                  pathname.includes('/panel/management/document') ? 'bg-purple-500' : 'bg-indigo-500'
                } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
              >
                Documents
              </button>
          ...
          <li>
            ...
            {isSidebarOpenanomalie && (
              <ul className="pl-4 mt-2 space-y-2 text-sm">
                <li>
                  <Link href={`/panel/management/anomalies/nav-anomalies`}>
                    <button
                      className={`block w-full py-2 px-2 ${
                        pathname.includes('/anomalies/nav-anomalies') ? 'bg-purple-500' : 'bg-indigo-500'
                      } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
                    >
                      Anomalies VL
                    </button>
                ...
                <li>
                  <Link href={`/panel/management/anomalies/missing-nav`}>
                    <button
                      className={`block w-full py-2 px-2 ${
                        pathname.includes('/anomalies/missing-nav') ? 'bg-purple-500' : 'bg-indigo-500'
                      } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
                    >
                      VL manquantes
                    </button>
          ...
          {/* Actualités */}
          <li>
            <Link href={`/panel/management/news`}>
              <button
                className={`block w-full py-3 px-4 ${
                  pathname.includes('/panel/management/news') ? 'bg-purple-500' : 'bg-indigo-500'
                } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
              >
                Actualités
              </button>
          ...
          {/* Reporting */}
          <li>
            <Link href={`/panel/management/reporting`}>
              <button
                className={`block w-full py-3 px-4 ${
                  pathname.includes('/panel/management/reporting') ? 'bg-purple-500' : 'bg-indigo-500'
                } hover:bg-blue-500 text-white font-semibold rounded-lg shadow-md transition duration-300`}
              >
                Reporting
              </button>
