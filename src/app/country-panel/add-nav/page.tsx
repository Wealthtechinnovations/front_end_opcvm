  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setTimeout(() => {
          const href = `/country-panel/fonds`;
          ...
          <div className="multinav">
            <div className="multinav-scroll" style={{ height: '97%' }}>
              <ul className="sidebar-menu" data-widget="tree">
                ...
                <li>
                  <Link href={`/country-panel/dashboard`} >
                ...
                <li className={`dropdown ${isDropdownOpen ? 'open' : ''}`}>
                  ...
                  {isDropdownOpen && (
                    <>
                      <li>
                        <a href={`/country-panel/validated-funds`}>   <i className="bi bi-check2"></i>
                          <span style={{ marginLeft: '55px' }}>Fonds validés</span></a>
                      </li>
                      <li>
                        <a href={`/country-panel/fonds`}>
                          <span style={{ marginLeft: '55px' }}>Fonds à validés</span></a>
                      </li>
                      <li>
                        <a href={`/country-panel/add-nav`}> <i data-feather={isDropdownOpen ? "minus-square" : "plus-square"}></i>
                          <span style={{ marginLeft: '55px' }}>Ajouter un fond</span></a>
                      </li>
                      <li>
                        <a href={`/country-panel/import-nav`}> <i data-feather={isDropdownOpen ? "minus-square" : "plus-square"}></i>
                ...
                <li>
                  <Link href={`/country-panel/anomalies`}  >
                    <i data-feather="plus-square"></i>
                    <span>Anomalies</span>
                  </Link>
                </li>
