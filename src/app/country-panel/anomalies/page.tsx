...
export default function Home() {
  ...
  const handleLinkClick = (item: any, typeAnomalie: any) => {
    ...
    if (typeAnomalie === 'ANOMALIE VL') {
      ...
      href = `/country-panel/anomalies/nav-anomalies?fond=${item}`;
    } else {
      // Rediriger l'utilisateur vers une autre page pour d'autres types d'anomalies
      href = `/country-panel/fonds/details?societeconneted=${id}&Id=${item}`;
    }
  ...
  const handleLogout = () => {
    ...
    setTimeout(() => {
      router.push('/home'); // Replace '/other-page' with your desired page URL
    }, 200);
  };
