...
export default function Fonds() {
  ...
  const handleFormSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const response = await fetch(`${urlconstant}/api/ajoutVL`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        /* router.push('/country-panel/fonds/details', {
  ...
  const handleFormSubmit1 = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const response = await fetch(`${urlconstant}/api/ajoutIndice`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleFormFileSubmit1 = async (e: any) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          const href = `/country-panel/dashboard`;
          window.location.href = href;  // This will navigate and refresh the page
