...
borderColor:'grey'
                    ...
                    <div className="row">
                      ...
                      <ul className="tabs-menu" style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap' }}>
                        <li>
                          <Link
...
borderColor:'grey'
                            ...
                            as={`/funds/performance/${id}`}
                            key={id} className="hover:underline">
                    ...
                    <div className="row">
                          ...
                          <div className="row">
                            <div className="col-md-6">
                              <div className="line-group">
                                <div>
                                  <p><strong>Société</strong>: {post?.data?.societe_gestion}</p>
                                  ...
                                  <p><strong>Catégorie global</strong>: {post?.data?.categorie_globale}</p>
                                  <p><strong>Catégorie local</strong>: {post?.data?.categorie_globale} {post?.data?.pays}</p>
                                  <p><strong>Catégorie sous régional</strong>: {post?.data?.categorie_regional}</p>
                            ...
                            <div className="col-md-6">
                              <div className="line-group">
                                <div>
                                  ...
                                  <p><strong>Ind de réf global</strong>: </p>
                                  <p><strong>Ind de réf local</strong>: {post?.data?.ID_indice}</p>
                                  <p><strong>Ind de réf sous régional</strong>: </p>
                                  <p><strong></strong>: </p>
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="col-md-2 mt-3 vl-box">
                        ...
                        <div className="vl-box-currencies">
                          <div className="vl-box-devise-value"> {post?.data?.lastValue}  {post?.data?.symboledevise != null ? post?.data?.symboledevise : "EUR"}</div>
                        </div><br></br>
                      ...
                      <table className="table table-sm">
                        ...
                        <tbody>
                          ...
                          {new Date().getFullYear() === post?.data?.performances?.data?.adaptValues1?.[0]?.[0] ? (
                            <>
                              <tr>
                                ...
                                <td className="text-right highlight">-9,48 %</td>
                              </tr>
                            </>
                          ) : null}
                          <tr>
                          ...
                          <tr>
                            ...
                            <td className={`text-right `}>{isNaN(parseFloat(post?.data?.ratios3a?.data?.perfAnnualisee)) ? '-' : parseFloat(post?.data?.ratios3a?.data?.perfAnnualisee).toFixed(2)}  %</td>
                            <td className={`text-right  `}>{isNaN(parseFloat(post?.data?.performances.data?.performancesCategorie[0]?.moyenne_perfannu3an)) || isNaN(parseFloat(post?.data?.ratios3a?.data?.perfAnnualisee)) ? '-' : parseFloat(post?.data?.performances.data?.performancesCategorie[0]?.moyenne_perfannu3an).toFixed(2)} %</td>
                          </tr>
                          <tr>
                            <td>
                              Volatilité{' '}
                            ...
                            <td className={`text-right `}>{isNaN(parseFloat(post?.data?.ratios3a?.data?.volatility)) ? '-' : parseFloat(post?.data?.ratios3a?.data?.volatility).toFixed(2)}  %</td>
                            <td className={`text-right  `}>{isNaN(parseFloat(post?.data?.performances.data?.performancesCategorie[0]?.moyenne_volatility3an)) || isNaN(parseFloat(post?.data?.ratios3a?.data?.volatility)) ? '-' : parseFloat(post?.data?.performances.data?.performancesCategorie[0]?.moyenne_volatility3an).toFixed(2)} %</td>
                          </tr>
                          <tr>
                            <td>
                              Sharpe{' '}
                            ...
                            <td className={`text-right `}>{isNaN(parseFloat(post?.data?.ratios3a?.data?.ratioSharpe)) ? '-' : parseFloat(post?.data?.ratios3a?.data?.ratioSharpe).toFixed(2)}  </td>
                            <td className={`text-right  `}>{isNaN(parseFloat(post?.data?.performances.data?.performancesCategorie[0]?.moyenne_ratiosharpe3an)) || isNaN(parseFloat(post?.data?.ratios3a?.data?.ratioSharpe)) ? '-' : parseFloat(post?.data?.performances.data?.performancesCategorie[0]?.moyenne_ratiosharpe3an).toFixed(2)} </td>
                          </tr>
                          <br></br>
                          <br></br>
                          <br></br>
                      ...
                      <table className="table table-sm">
                        ...
                        <tbody>
                          ...
                          <tr className="row-content">
                            ...
                            <td className="value highlight text-center no-wrap">10,78 %</td>
                            <td className="notation">
                              <div className="conseil-default conseil-selected"></div>
                              <div className="conseil-default conseil-selected"></div>
                              <div className="conseil-default"></div>
                    ...
                    <table className="table table-sm">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="text-right highlight"> {isNaN(post?.data?.frais_sortie)
                            ? "-"
                            : (post?.data?.frais_sortie * 100).toFixed(2) + "%"} </td>
                        </tr>
                        <br />
                        <tr>
