...
import { Fragment, JSXElementConstructor, Key, PromiseLikeOfReactNode, ReactElement, ReactNode, useEffect, useState } from "react";
...
export default function Ajoutvl() {
  ...
  // Ajoutez un useEffect pour mettre à jour les options de structure en fonction de la classification
  useEffect(() => {
    if (formData.classification) {
      setFormData({ ...formData, structure_fond: '' }); // Réinitialiser la structure_fond
    }
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const response = await fetch(`${urlconstant}/api/postfond`, {
        method: 'POST',
        headers: {
      ...
      if (response.status === 200) {
        ...
        setTimeout(() => {
          const href = `/panel/management/pending-funds`;
                              ...
                              <div>
                                ...
                                <div className="col-md-12 mx-auto">                                <label>
                                  ...
                                  <input
                                    ...
                                    value={formData.indice_benchmark}
                                ...
                                <div className="row">
                                  <div className="col-md-6 mx-auto">                                <label>
                                    ...
                                    <input
                                      ...
                                      value={formData.montant_premier_vl}
                                  ...
                                  <div className="col-md-6 mx-auto">                                <label>
                                    ...
                                    <input
                                      ...
                                      value={formData.date_premiere_vl}
                                ...
                                <div className="row">
                                  <div className="col-md-6">
                                    ...
                                    <textarea
                                      ...
                                      value={formData.philosophie_fond}
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <textarea
                                      ...
                                      value={formData.strategie_politique_invest}
                              ...
                              <div>
                                <div className="row">
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      value={formData.minimum_investissement}
                                ...
                                <div className="row">
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.periodicite} onChange={(e) => setFormData({ ...formData, periodicite: e.target.value })}>
                                  ...
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.horizonplacement} onChange={(e) => setFormData({ ...formData, horizonplacement: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                  ...
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.date_cloture} onChange={(e) => setFormData({ ...formData, date_cloture: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                      <option value="MOINS D UN AN">MOINS D UN AN</option>
                                      <option value="AU MOINS 2 ANS">AU MOINS 2 ANS</option>
                                      <option value="AU MOINS 3 ANS">AU MOINS 3 ANS</option>
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      className="form-control"
                                      name="montant_actif_net"
                                      value={formData.montant_actif_net}
                                ...
                                <div className="row">
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.classification} onChange={(e) => setFormData({ ...formData, classification: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                  ...
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.structure_fond} onChange={(e) => setFormData({ ...formData, structure_fond: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      value={formData.delai_reglement}
                                ...
                                <div className="row">
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.categorie_globale} onChange={(e) => setFormData({ ...formData, categorie_globale: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                  ...
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.souscripteur} onChange={(e) => setFormData({ ...formData, souscripteur: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                  ...
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.affectation} onChange={(e) => setFormData({ ...formData, affectation: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                ...
                                <div className="row">
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      value={formData.agent_transfert}
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      value={formData.teneur_registre}
                                ...
                                <div className="row">
                                  <div className="col-6">
                                    ...
                                    <select className="form-control" value={formData.duree_investissement_recommande} onChange={(e) => setFormData({ ...formData, duree_investissement_recommande: e.target.value })}>
                                      <option value="">Sélectionnez...</option>
                                      <option value="MOINS D UN AN">MOINS D UN AN</option>
                                      <option value="AU MOINS 2 ANS">AU MOINS 2 ANS</option>
                                      <option value="AU MOINS 3 ANS">AU MOINS 3 ANS</option>
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <input
                                      ...
                                      value={formData.frais_souscription}
