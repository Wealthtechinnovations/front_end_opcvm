  ...
  const handleLogin = async (e: any) => {
    ...
    if (password === "") {
      ...
      if (data.code === 200) {
        ...
        router.push(`/panel/data-requester/login/register?email=${email}`);
      }
    } else {
                ...
                <div className="col-lg-5 col-md-5 col-12">
                  <div className="bg-white rounded10 shadow-lg">
                    <div className="content-top-agile p-20 pb-0">
                      <h2 className="text-primary fw-600">Connexion Data Requester</h2>
                    </div>
                    <div className="p-60">
                      <form onSubmit={handleLogin}>
                        ...
                        {showPassword && (
                          <div className="col-12 text-center mt-3">
                            <Link
                              href="/panel/data-requester/login/forgot-password"
