  ...
  const handleLogin = async (e: any) => {
    ...
    if (password === "") {
      ...
      if (data.code === 200) {
        ...
        router.push(`/panel/portfolio/login/register?email=${email}`);
      }
    } else {
    ...
    <Fragment>
      <nav className="main-nav bg-white" role="navigation">
        ...
        <ul id="main-menu" className="sm sm-blue">
          ...
          <li>
            <Link className="link-style" href="/panel/portfolio/login" style={{ backgroundColor: "#3b82f6", color: "white" }}>
              Espace client
            </Link>
          </li>
          <li>
                      ...
                      <form onSubmit={handleLogin}>
                        ...
                        {showPassword && (
                          <div className="col-12 text-center mt-3">
                            <Link
                              href="/panel/portfolio/login/forgot-password"
