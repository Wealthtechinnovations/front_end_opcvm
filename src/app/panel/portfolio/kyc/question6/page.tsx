...
export default function Profile(): JSX.Element {
    ...
    const [currentKycEntrepriseStatut, setCurrentKycEntrepriseStatut] = useState<string | null>(null); // Initialize as string or null
    ...
    const addUserPicture = useCallback(async () => {
        ...
        try {
            ...
            const result = await fetch(`${urlstableconstant}/api/kyc/particular/kyc-selfie-with-document`, {
                method: "PUT",
                ...
                Swal.fire({
                    ...
                    setTimeout(() => {
                        if (currentKycStatut === "1") {
                            router.push("/panel/portfolio/kyc/resultat-kyc");

                        } else {
                            router.push("/panel/portfolio/kyc/question7");
                        }
                            ...
                            <ul className="sidebar-menu" data-widget="tree">
                                ...
                                <li className={`dropdown ${isDropdownOpen ? 'open' : ''}`}>
                                    ...
                                    {isDropdownOpen && (
                                        <>
                                            <li>
                                                <a href={`/panel/portfolio/profile`}>   <i className="bi bi-check2"></i>
                                                    <span style={{ marginLeft: '55px' }}>Profil</span></a>
                                            </li>
                                            <li>
                                                <a href={`/panel/portfolio/questionnaire`}>
                                                    <span style={{ marginLeft: '55px' }}>Questionnaire</span></a>
                                            </li>
                                            <li>
                                                <a href={`/panel/portfolio/kyc`}>
                    ...
                    <div className='m-4 p-3 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white cryptocurrency-search-box login-form col-lg-8 col-md-12'>
                        <form className=''>
                            <div className='row'>
                                ...
                                <div className='col-4'>
                                    <img src="/images/selfie_with_doc.png" alt="Selfie" />
                                </div>
