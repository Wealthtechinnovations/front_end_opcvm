...
export default function Profile(): JSX.Element {
  ...
  const updateQuestionFour = async (event: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const result = await fetch(`${urlstableconstant}/api/profile/opcvm/update-questionFour`, {
        method: "PUT",
      ...
      */
      if (data.message) {
        ...
        Swal.fire({
          ...
          setTimeout(() => {
            router.push("/panel/portfolio/questionnaire/pre/question5");
          }, 5000)
      }
      // Fin condition 
    } catch {
