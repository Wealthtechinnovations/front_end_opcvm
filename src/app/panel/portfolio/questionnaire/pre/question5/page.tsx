...
export default function Profile(): JSX.Element {
  ...
  const updateQuestionFive = async (event: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const result = await fetch(`${urlstableconstant}/api/profile/opcvm/update-questionFive`, {
        method: "PUT",
      ...
      */
      if (data.message) {
        ...
        Swal.fire({
          ...
          setTimeout(() => {
            router.push("/panel/portfolio/questionnaire/pre/question6");
          }, 5000)
      }
      // Fin condition 
    } catch {
