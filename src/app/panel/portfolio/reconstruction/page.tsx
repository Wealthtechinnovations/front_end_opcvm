...
export default function PorteFeuile() {
  ...
  const handletransactionClick = async () => {
    const href = `/panel/portfolio/portefeuillereconstitution/transaction?selectedfund=${selectedfunds}&portefeuille=${selectedportfeuille}`
    setTimeout(() => {
  ...
  const handleparamClick = async () => {
    const href = `/panel/portfolio/portefeuillereconstitution/parametrage?selectedfund=${selectedfunds}&portefeuille=${selectedportfeuille}`
    setTimeout(() => {
      window.location.href = href;
    }, 500);
  ...
  const handleReconstitutionClick = async () => {
    ...
    try {
      ...
      if (data.code === 200) {
        ...
        setTimeout(() => {
          const href = `/panel/portfolio/portefeuillereconstitution?selectedValuename=${selectedValuename}&selectedfund=${selectedfunds}&portefeuille=${selectedportfeuille}`;
          window.location.href = href;
        }, 500);
      } else {
                ...
                <div className="box-body pb-lg-0">
                  ...
                  <div className="d-md-flex justify-content-between align-items-center">
                    ...
                    <div className="text-right">
                      <a
                        href={`/panel/portfolio/portefeuillereconstitution/ajoutcash?selectedfund=${selectedfunds}&portefeuille=${selectedportfeuille}`}
                      ...
                      &nbsp;
                      <a
                        href={`/panel/portfolio/portefeuillereconstitution/retraitcash?selectedfund=${selectedfunds}&portefeuille=${selectedportfeuille}`}
                        /*  as={`/about/${selectedRows ? selectedRows.join(',') : ''}`}
                          key={selectedRows.join(',')}*/
                        style={{
                          width: '150px',
                ...
                <table className="table">
                  ...
                  <tbody >
                    {fundsData.map((data, index) => (
                      <tr key={index}>
                        <td className="text-center"> <Link href={`/funds/${data.data.funds[0]?.id}`}>
                        ...
                        <td className="text-center">
                          {portefeuille?.data.portefeuille.cash != null && portefeuille?.data.portefeuille.cash !== 0 && (
                            <div className="text-center">
                              <Link
                                href={{
                                  pathname: '/panel/portfolio/portefeuillereconstitution/achat',
                                  query: {
                              ...
                              <Link
                                href={{
                                  pathname: '/panel/portfolio/portefeuillereconstitution/vente',
