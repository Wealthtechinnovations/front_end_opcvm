...
export default function Ajoutcash(props: PageProps) {
  ...
  const [entries, setEntries] = useState([
    { date: '', type: 'ajoutcash', montant: 0, cash: 0, portefeuilleselect: null },
  ]);
  const prevPage = () => {
    setFormData({ ...formData, page: formData.page - 1 });
  };
      ...
      fetch(`${urlconstant}/api/managecash`, {
        ...
        .then((data) => {
          ...
          if (data.code === 200) {
            ...
            setTimeout(() => {
              const href = `/panel/portefeuille/portefeuillereconstitution?id=${id}&selectedfund=${selectedfunds}&portefeuille=${selectedportfeuille}`;
              ...
              <div className="box ">
                <div className="box-body">
                  <div className="d-md justify-content-between align-items-center">
                    ...
                    <div>
                      <p><span className="text-primary">Ajout de cash</span> | <span className="text-fade"></span></p>
