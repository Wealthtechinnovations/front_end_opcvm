                ...
                Swal.fire({
                    ...
                    setTimeout(() => {
                        if (currentKycStatut === "1") {
                            router.push("/panel/investor/kyc/resultat-kyc");

                        } else {
                            router.push("/panel/investor/kyc/question7");
                        }
                            ...
                            <ul className="sidebar-menu" data-widget="tree">
                                ...
                                <li className={`dropdown ${isDropdownOpen ? 'open' : ''}`}>
                                    ...
                                    {isDropdownOpen && (
                                        <>
                                            <li>
                                                <a href={`/panel/investor/profile`}>   <i className="bi bi-check2"></i>
                                                    <span style={{ marginLeft: '55px' }}>Profil</span></a>
                                            </li>
                                            <li>
                                                <a href={`/panel/investor/questionnaire`}>
                                                    <span style={{ marginLeft: '55px' }}>Questionnaire</span></a>
                                            </li>
                                            <li>
                                                <a href={`/panel/investor/kyc`}>
