...
$(function () {
    ...
    Morris.Area({
        ...
        pointSize: 3,
        fillOpacity: 0,
        pointStrokeColors: ['#3b82f6', '#51ce8a', '#733aeb'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 3,
        hideHover: 'auto',
        lineColors: ['#3b82f6', '#51ce8a', '#733aeb'],
        resize: true
    ...
    Morris.Area({
        ...
        pointSize: 0,
        fillOpacity: 0.4,
        pointStrokeColors: ['#f2426d', '#3b82f6'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 0,
        smooth: false,
        hideHover: 'auto',
        lineColors: ['#f2426d', '#3b82f6'],
        resize: true
    ...
    Morris.Bar({
        ...
        ykeys: ['a', 'b', 'c'],
        labels: ['A', 'B', 'C'],
        barColors: ['#fec801', '#3b82f6', '#51ce8a'],
        hideHover: 'auto',
        gridLineColor: '#eef0f2',
        resize: true
    });
    ...
    Morris.Area({
        ...
        lineColors: ['#3b82f6', '#f2426d', '#fec801'],
        xkey: 'period',
        ykeys: ['data1', 'data2', 'data3'],
        labels: ['Data 1', 'Data 2', 'Data 3'],
        pointSize: 0,
